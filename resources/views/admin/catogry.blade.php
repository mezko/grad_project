            ...
            <div class="col-lg-10">
                ...
                <form method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="exampleInputEmail1" placeholder="مقهى" name="ar">

                    </div>
                    <div class="form-group">
                        <label for="exampleInputPassword1">Name In English</label>
                        <input type="text" class="form-control" id="exampleInputPassword1" placeholder="café"
                            name="en">
                    </div>
